...
const Aboutme = () => {
    ...
    <div class="row card-body">
        ...
        <div class = "col-sm-8"> 
            <p1 class="card-text1">As a University of Denver Coding Bootcamp alumni that graduated with a 4.0, I am confident that I have what it takes to be a part of your web development team with my expertise in modern HTML/CSS, JavaScript, ReactJS, NodeJS, MongoDB, SQL, Algorithms, Amazon Web Services, and REST APIs. Even though I graduated from a Coding Bootcamp rather than a traditional University, I have no doubt you wouldn’t regret giving me a chance to prove myself for what I can bring to your team! 
            <br/>
