...
const Aboutme = () => {
    ...
    <div class="row card-body">
        ...
        <div class = "col-sm-8"> 
            ...
            <br/>
            I would be honored to bring my skills, passion, and work ethic to support your company’s team. I am sure that I would work harder than everyone else because although I’m the least experienced in order to help the company goals.
            <br/>
            </p1>
